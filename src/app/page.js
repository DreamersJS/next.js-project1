    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100" aria-label="Homepage">
      ...
      <div className="mb-6" aria-labelledby="create-whiteboard-section">
        <button
          ...
          className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition"
          disabled={!user?.uid}
        >
          Create a New Whiteboard
        </button>
